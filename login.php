...
$email = $_POST["email"];  //gets input from user from customer_login.php
$pass = $_POST["pass"];
...
$sql = "SELECT customer_id, first_name, last_name, password, email, birthdate, country  FROM customer WHERE password='$pass' and email='$email'";
...
if ($result->num_rows > 0) {
  ...
  header('Location: /Car_rental_system/customer_login.php? error=1');
}
$conn->close();
